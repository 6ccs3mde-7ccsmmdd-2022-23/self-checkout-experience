...
import self_checkout_experience.ide.contentassist.antlr.internal.InternalSelfCheckoutParser;
import self_checkout_experience.services.SelfCheckoutGrammarAccess;

public class SelfCheckoutParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		@Inject
		public NameMappings(SelfCheckoutGrammarAccess grammarAccess) {
	...
	@Override
	protected InternalSelfCheckoutParser createParser() {
		InternalSelfCheckoutParser result = new InternalSelfCheckoutParser(null);
