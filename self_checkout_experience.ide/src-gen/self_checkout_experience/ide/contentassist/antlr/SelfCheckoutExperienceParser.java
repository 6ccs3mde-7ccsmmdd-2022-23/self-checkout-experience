...
public class SelfCheckoutExperienceParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, SelfCheckoutExperienceGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getRepeatAccess().getStatementAlternatives_3_0(), "rule__Repeat__StatementAlternatives_3_0");
			...
			builder.put(grammarAccess.getRepeatAccess().getStatementAssignment_3(), "rule__Repeat__StatementAssignment_3");
