 ...
 * </p>
 * <ul>
 *   <li>{@link self_checkout_experience.selfCheckout.impl.TurnStatementImpl#getCommand <em>Command</em>}</li>
 *   <li>{@link self_checkout_experience.selfCheckout.impl.TurnStatementImpl#getDegrees <em>Degrees</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TurnStatementImpl extends WalkStatementImpl implements TurnStatement
{
  ...
  {
    return SelfCheckoutPackage.Literals.TURN_STATEMENT;
  }
  ...
  public void setCommand(TurnCommand newCommand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.TURN_STATEMENT__COMMAND, oldCommand, command));
  }
  ...
  public NotificationChain basicSetDegrees(Expression newDegrees, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.TURN_STATEMENT__DEGREES, oldDegrees, newDegrees);
  ...
  public void setDegrees(Expression newDegrees)
  {
    if (newDegrees != degrees)
    {
      ...
      if (degrees != null)
        msgs = ((InternalEObject)degrees).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutPackage.TURN_STATEMENT__DEGREES, null, msgs);
      if (newDegrees != null)
        msgs = ((InternalEObject)newDegrees).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutPackage.TURN_STATEMENT__DEGREES, null, msgs);
      msgs = basicSetDegrees(newDegrees, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.TURN_STATEMENT__DEGREES, newDegrees, newDegrees));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SelfCheckoutPackage.TURN_STATEMENT__DEGREES:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SelfCheckoutPackage.TURN_STATEMENT__COMMAND:
        return getCommand();
      case SelfCheckoutPackage.TURN_STATEMENT__DEGREES:
        return getDegrees();
    }
