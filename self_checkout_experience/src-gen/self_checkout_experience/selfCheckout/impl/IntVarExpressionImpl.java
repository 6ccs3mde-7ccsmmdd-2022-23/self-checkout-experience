 ...
 * </p>
 * <ul>
 *   <li>{@link self_checkout_experience.selfCheckout.impl.IntVarExpressionImpl#getVar <em>Var</em>}</li>
 * </ul>
 *
 * @generated
 */
public class IntVarExpressionImpl extends ExpressionImpl implements IntVarExpression
{
  ...
  {
    return SelfCheckoutPackage.Literals.INT_VAR_EXPRESSION;
  }
    ...
    if (var != null && var.eIsProxy())
    {
      ...
      if (var != oldVar)
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, SelfCheckoutPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
      }
    }
    return var;
  }
  ...
  public void setVar(VariableDeclaration newVar)
  {
    ...
    var = newVar;
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.INT_VAR_EXPRESSION__VAR, oldVar, var));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SelfCheckoutPackage.INT_VAR_EXPRESSION__VAR:
