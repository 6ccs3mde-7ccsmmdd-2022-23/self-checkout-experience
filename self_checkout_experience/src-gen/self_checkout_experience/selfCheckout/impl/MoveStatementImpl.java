 ...
 * </p>
 * <ul>
 *   <li>{@link self_checkout_experience.selfCheckout.impl.MoveStatementImpl#getCommand <em>Command</em>}</li>
 *   <li>{@link self_checkout_experience.selfCheckout.impl.MoveStatementImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MoveStatementImpl extends WalkStatementImpl implements MoveStatement
{
  ...
  {
    return SelfCheckoutPackage.Literals.MOVE_STATEMENT;
  }
  ...
  public void setCommand(MoveCommand newCommand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.MOVE_STATEMENT__COMMAND, oldCommand, command));
  }
  ...
  public NotificationChain basicSetSteps(Expression newSteps, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.MOVE_STATEMENT__STEPS, oldSteps, newSteps);
  ...
  public void setSteps(Expression newSteps)
  {
    if (newSteps != steps)
    {
      ...
      if (steps != null)
        msgs = ((InternalEObject)steps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutPackage.MOVE_STATEMENT__STEPS, null, msgs);
      if (newSteps != null)
        msgs = ((InternalEObject)newSteps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutPackage.MOVE_STATEMENT__STEPS, null, msgs);
      msgs = basicSetSteps(newSteps, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutPackage.MOVE_STATEMENT__STEPS, newSteps, newSteps));
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case SelfCheckoutPackage.MOVE_STATEMENT__STEPS:
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SelfCheckoutPackage.MOVE_STATEMENT__COMMAND:
        return getCommand();
      case SelfCheckoutPackage.MOVE_STATEMENT__STEPS:
        return getSteps();
    }
