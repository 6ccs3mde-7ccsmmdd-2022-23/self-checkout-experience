...
@Singleton
public class SelfCheckoutGrammarAccess extends AbstractElementFinder.AbstractGrammarElementFinder {
	
	public class Self_checkoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Self_checkout");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Alternatives cAlternatives_0 = (Alternatives)cGroup.eContents().get(0);
		private final Assignment cPickAssignment_0_0 = (Assignment)cAlternatives_0.eContents().get(0);
		private final RuleCall cPickPickParserRuleCall_0_0_0 = (RuleCall)cPickAssignment_0_0.eContents().get(0);
		...
		//pick+=Pick
		public Assignment getPickAssignment_0_0() { return cPickAssignment_0_0; }
		
		//Pick
		public RuleCall getPickPickParserRuleCall_0_0_0() { return cPickPickParserRuleCall_0_0_0; }
	...
	public class PickElements extends AbstractParserRuleElementFinder {
		...
		private final Assignment cHoldingItemAssignment_3 = (Assignment)cGroup.eContents().get(3);
		private final Alternatives cHoldingItemAlternatives_3_0 = (Alternatives)cHoldingItemAssignment_3.eContents().get(0);
		...
		//holdingItem = (AddToBasket | Drop)
		public Assignment getHoldingItemAssignment_3() { return cHoldingItemAssignment_3; }
		
		//(AddToBasket | Drop)
		public Alternatives getHoldingItemAlternatives_3_0() { return cHoldingItemAlternatives_3_0; }
		
		//AddToBasket
		public RuleCall getHoldingItemAddToBasketParserRuleCall_3_0_0() { return cHoldingItemAddToBasketParserRuleCall_3_0_0; }
		
		//Drop
		public RuleCall getHoldingItemDropParserRuleCall_3_0_1() { return cHoldingItemDropParserRuleCall_3_0_1; }
	}
	public class AddToBasketElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.AddToBasket");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cItemPickCrossReference_3_0 = (CrossReference)cItemAssignment_3.eContents().get(0);
		private final RuleCall cItemPickIDTerminalRuleCall_3_0_1 = (RuleCall)cItemPickCrossReference_3_0.eContents().get(1);
		
		//AddToBasket:
		//    "add" "to" "basket" item=[Pick]
		//;
		@Override public ParserRule getRule() { return rule; }
		...
		//[Pick]
		public CrossReference getItemPickCrossReference_3_0() { return cItemPickCrossReference_3_0; }
		
		//ID
		public RuleCall getItemPickIDTerminalRuleCall_3_0_1() { return cItemPickIDTerminalRuleCall_3_0_1; }
	}
	public class DropElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Drop");
		private final Group cGroup = (Group)rule.eContents().get(1);
		...
		private final CrossReference cItemPickCrossReference_1_0 = (CrossReference)cItemAssignment_1.eContents().get(0);
		private final RuleCall cItemPickIDTerminalRuleCall_1_0_1 = (RuleCall)cItemPickCrossReference_1_0.eContents().get(1);
		...
		//[Pick]
		public CrossReference getItemPickCrossReference_1_0() { return cItemPickCrossReference_1_0; }
		
		//ID
		public RuleCall getItemPickIDTerminalRuleCall_1_0_1() { return cItemPickIDTerminalRuleCall_1_0_1; }
	}
	public class WalkStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.WalkStatement");
	...
	public class VariableDeclarationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.VariableDeclaration");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class LoopStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.LoopStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MoveStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.MoveStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class TurnStatementElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.TurnStatement");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AdditionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Addition");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class MultiplicationElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Multiplication");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class PrimaryElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Primary");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class IntLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.IntLiteral");
	...
	public class RealLiteralElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.RealLiteral");
		private final Assignment cValAssignment = (Assignment)rule.eContents().get(1);
	...
	public class IntVarExpressionElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.IntVarExpression");
	...
	public class REALElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.REAL");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class CheckoutElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Checkout");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class ScanElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Scan");
		private final Group cGroup = (Group)rule.eContents().get(1);
	...
	public class AddToBagElements extends AbstractParserRuleElementFinder {
		private final ParserRule rule = (ParserRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.AddToBag");
		private final Group cGroup = (Group)rule.eContents().get(1);
		private final Keyword cAddKeyword_0 = (Keyword)cGroup.eContents().get(0);
		private final Keyword cToKeyword_1 = (Keyword)cGroup.eContents().get(1);
	...
	public class MoveCommandElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.MoveCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class TurnCommandElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.TurnCommand");
		private final Alternatives cAlternatives = (Alternatives)rule.eContents().get(1);
	...
	public class PayElements extends AbstractElementFinder.AbstractEnumRuleElementFinder {
		private final EnumRule rule = (EnumRule) GrammarUtil.findRuleForName(getGrammar(), "self_checkout_experience.SelfCheckout.Pay");
	...
	@Inject
	public SelfCheckoutGrammarAccess(GrammarProvider grammarProvider,
	...
	protected Grammar internalFindGrammar(GrammarProvider grammarProvider) {
		...
		while (grammar != null) {
			if ("self_checkout_experience.SelfCheckout".equals(grammar.getName())) {
				return grammar;
			}
