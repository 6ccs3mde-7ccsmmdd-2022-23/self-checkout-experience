 ...
 * </p>
 * <ul>
 *   <li>{@link self_checkout_experience.selfCheckoutExperience.impl.MultiplicationImpl#getLeft <em>Left</em>}</li>
 *   <li>{@link self_checkout_experience.selfCheckoutExperience.impl.MultiplicationImpl#getOperator <em>Operator</em>}</li>
 *   <li>{@link self_checkout_experience.selfCheckoutExperience.impl.MultiplicationImpl#getRight <em>Right</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MultiplicationImpl extends ExpressionImpl implements Multiplication
{
  ...
  {
    return SelfCheckoutExperiencePackage.Literals.MULTIPLICATION;
  }
  ...
  public NotificationChain basicSetLeft(Expression newLeft, NotificationChain msgs)
  {
    ...
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SelfCheckoutExperiencePackage.MULTIPLICATION__LEFT, oldLeft, newLeft);
  ...
  public void setLeft(Expression newLeft)
  {
    if (newLeft != left)
    {
      ...
      if (left != null)
        msgs = ((InternalEObject)left).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutExperiencePackage.MULTIPLICATION__LEFT, null, msgs);
      if (newLeft != null)
        msgs = ((InternalEObject)newLeft).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutExperiencePackage.MULTIPLICATION__LEFT, null, msgs);
      msgs = basicSetLeft(newLeft, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutExperiencePackage.MULTIPLICATION__LEFT, newLeft, newLeft));
  }
  ...
  public EList<String> getOperator()
  {
    if (operator == null)
    {
      operator = new EDataTypeEList<String>(String.class, this, SelfCheckoutExperiencePackage.MULTIPLICATION__OPERATOR);
    }
    return operator;
  }
