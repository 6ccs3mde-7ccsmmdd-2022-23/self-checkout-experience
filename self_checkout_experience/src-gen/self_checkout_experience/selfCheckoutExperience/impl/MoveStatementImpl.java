 ...
 * </p>
 * <ul>
 *   <li>{@link self_checkout_experience.selfCheckoutExperience.impl.MoveStatementImpl#getCommand <em>Command</em>}</li>
 *   <li>{@link self_checkout_experience.selfCheckoutExperience.impl.MoveStatementImpl#getSteps <em>Steps</em>}</li>
 * </ul>
 *
 * @generated
 */
public class MoveStatementImpl extends WalkStatementImpl implements MoveStatement
{
  /**
  ...
  {
    return SelfCheckoutExperiencePackage.Literals.MOVE_STATEMENT;
  }
  ...
  public void setCommand(MoveCommand newCommand)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutExperiencePackage.MOVE_STATEMENT__COMMAND, oldCommand, command));
  }
  ...
  public NotificationChain basicSetSteps(IntExpression newSteps, NotificationChain msgs)
  {
    ...
    if (eNotificationRequired())
    {
      ENotificationImpl notification = new ENotificationImpl(this, Notification.SET, SelfCheckoutExperiencePackage.MOVE_STATEMENT__STEPS, oldSteps, newSteps);
  ...
  public void setSteps(IntExpression newSteps)
  {
    if (newSteps != steps)
    {
      ...
      if (steps != null)
        msgs = ((InternalEObject)steps).eInverseRemove(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutExperiencePackage.MOVE_STATEMENT__STEPS, null, msgs);
      if (newSteps != null)
        msgs = ((InternalEObject)newSteps).eInverseAdd(this, EOPPOSITE_FEATURE_BASE - SelfCheckoutExperiencePackage.MOVE_STATEMENT__STEPS, null, msgs);
      msgs = basicSetSteps(newSteps, msgs);
      if (msgs != null) msgs.dispatch();
    }
    else if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutExperiencePackage.MOVE_STATEMENT__STEPS, newSteps, newSteps));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SelfCheckoutExperiencePackage.MOVE_STATEMENT__COMMAND:
        return getCommand();
      case SelfCheckoutExperiencePackage.MOVE_STATEMENT__STEPS:
        return getSteps();
    }
