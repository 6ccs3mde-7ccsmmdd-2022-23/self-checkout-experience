...
/**
 * <!-- begin-user-doc -->
 * An implementation of the model object '<em><b>Hold Self Scanner</b></em>'.
 * <!-- end-user-doc -->
 * <p>
 * The following features are implemented:
 * </p>
 * <ul>
 *   <li>{@link self_checkout_experience.selfCheckoutExperience.impl.HoldSelfScannerImpl#getScanMachine <em>Scan Machine</em>}</li>
 * </ul>
 *
 * @generated
 */
public class HoldSelfScannerImpl extends MinimalEObjectImpl.Container implements HoldSelfScanner
{
  /**
  ...
  {
    return SelfCheckoutExperiencePackage.Literals.HOLD_SELF_SCANNER;
  }
  ...
  public void setScanMachine(SelfScanner newScanMachine)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, SelfCheckoutExperiencePackage.HOLD_SELF_SCANNER__SCAN_MACHINE, oldScanMachine, scanMachine));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case SelfCheckoutExperiencePackage.HOLD_SELF_SCANNER__SCAN_MACHINE:
